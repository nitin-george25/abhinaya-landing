  ...
  return (
    <footer style={{ background: "var(--cod-gray)", paddingTop: 80 }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 32px 40px" }}>
        <StaggerGroup style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(min(220px,100%),1fr))", gap: 48, paddingBottom: 56, borderBottom: "1px solid var(--border)" }}>
          <StaggerItem>
            <LogoLockup size={32} />
